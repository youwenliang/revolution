            ...
            <div className="mw9 center ph2">
              <div className="cf df intro">
                ...
                <div className="o2 w-100 w-50-l pl4-l tl-l tc df dfc">
                  ...
                  <div class="fb-like w-100 mt3 hideme-right hidediv" data-href="https://developers.facebook.com/docs/plugins/" data-width="300" data-layout="standard" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
                </div>
              </div>
            </div>
          </div>
